...
VL_INLINE_OPT void Vstopwatch_top::_sequent__TOP__1(Vstopwatch_top__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->rst_n) {
        if (vlTOPp->reset) {
            ...
            if (vlTOPp->stopwatch_top__DOT__stopwatch_start) {
    ...
    if (vlTOPp->rst_n) {
        if (vlTOPp->reset) {
            ...
            if (((0x3bU == (IData)(vlTOPp->seconds)) 
                 & (IData)(vlTOPp->stopwatch_top__DOT__stopwatch_start))) {
...
VL_INLINE_OPT void Vstopwatch_top::_settle__TOP__2(Vstopwatch_top__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->stopwatch_top__DOT__fsm_inst__DOT__next_state 
        ...
        [vlTOPp->__Vtableidx1];
    vlTOPp->stopwatch_top__DOT__stopwatch_start = vlTOPp->__Vtable1_stopwatch_top__DOT__stopwatch_start
        [vlTOPp->__Vtableidx1];
