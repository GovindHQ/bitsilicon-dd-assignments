...
void Vstopwatch_top___024root___eval_triggers__act(Vstopwatch_top___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.set(1U, (((IData)(vlSelf->clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__clk__0))) 
                                     | ((IData)(vlSelf->stopwatch_top__DOT__sec_inst__DOT__rst_combined) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__stopwatch_top__DOT__sec_inst__DOT__rst_combined__0)))));
    vlSelf->__VactTriggered.set(2U, (((IData)(vlSelf->clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__clk__0))) 
                                     | ((IData)(vlSelf->stopwatch_top__DOT__min_inst__DOT__rst_combined) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__stopwatch_top__DOT__min_inst__DOT__rst_combined__0)))));
