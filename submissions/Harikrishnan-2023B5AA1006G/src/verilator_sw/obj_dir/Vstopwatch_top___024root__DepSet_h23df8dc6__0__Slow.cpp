...
#endif
            VL_FATAL_MT("../rtl/stopwatch_top.v", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vstopwatch_top___024root___ctor_var_reset(Vstopwatch_top___024root* vlSelf) {
    ...
    vlSelf->stopwatch_top__DOT__fsm__DOT__state = VL_RAND_RESET_I(2);
    vlSelf->stopwatch_top__DOT__fsm__DOT__next_state = VL_RAND_RESET_I(2);
