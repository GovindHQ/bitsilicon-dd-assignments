...
VL_MODULE(Vstopwatch_top) {
  public:
    ...
    CData/*0:0*/ stopwatch_top__DOT__sec_min;
    CData/*1:0*/ stopwatch_top__DOT__u_fsm__DOT__state;
    CData/*1:0*/ stopwatch_top__DOT__u_fsm__DOT__next_st;
    ...
    static CData/*1:0*/ __Vtable1_stopwatch_top__DOT__u_fsm__DOT__next_st[32];
