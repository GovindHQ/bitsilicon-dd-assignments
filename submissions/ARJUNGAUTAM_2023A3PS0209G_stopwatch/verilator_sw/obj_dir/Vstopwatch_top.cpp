...
void Vstopwatch_top::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("../rt1/stopwatch_top.v", 1, "",
...
VL_INLINE_OPT void Vstopwatch_top::_sequent__TOP__1(Vstopwatch_top__Syms* __restrict vlSymsp) {
    ...
    CData/*1:0*/ __Vdly__status;
    CData/*5:0*/ __Vdly__seconds;
    CData/*7:0*/ __Vdly__minutes;
    // Body
    __Vdly__status = vlTOPp->status;
    __Vdly__seconds = vlTOPp->seconds;
    __Vdly__minutes = vlTOPp->minutes;
    __Vtableidx1 = (((IData)(vlTOPp->stop) << 5U) | 
                    (((IData)(vlTOPp->start) << 4U) 
                     | (((IData)(vlTOPp->status) << 2U) 
                        | (((IData)(vlTOPp->reset) 
                            << 1U) | (IData)(vlTOPp->rst_n)))));
    if (vlTOPp->__Vtablechg1[__Vtableidx1]) {
        __Vdly__status = vlTOPp->__Vtable1_status[__Vtableidx1];
    }
    if ((1U & ((~ (IData)(vlTOPp->rst_n)) | (IData)(vlTOPp->reset)))) {
        __Vdly__minutes = 0U;
    } else {
        if (vlTOPp->stopwatch_top__DOT__rollover) {
            __Vdly__minutes = (0xffU & ((IData)(1U) 
    ...
    if ((1U & ((~ (IData)(vlTOPp->rst_n)) | (IData)(vlTOPp->reset)))) {
        __Vdly__seconds = 0U;
        vlTOPp->stopwatch_top__DOT__rollover = 0U;
    } else {
        if ((1U == (IData)(vlTOPp->status))) {
            if ((0x3bU == (IData)(vlTOPp->seconds))) {
                __Vdly__seconds = 0U;
                vlTOPp->stopwatch_top__DOT__rollover = 1U;
            } else {
