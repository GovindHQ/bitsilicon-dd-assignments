...
VL_INLINE_OPT void Vstopwatch_top___024root___nba_sequent__TOP__0(Vstopwatch_top___024root* vlSelf) {
    ...
    if (vlSelf->rst_n) {
        if (vlSelf->stopwatch_top__DOT__min_increment) {
            if ((0x63U == (IData)(vlSelf->minutes))) {
                __Vdly__minutes = 0U;
            } else if (vlSelf->stopwatch_top__DOT__min_increment) {
                __Vdly__minutes = (0x7fU & ((IData)(1U) 
                                            + (IData)(vlSelf->minutes)));
            }
        }
        if ((1U == (IData)(vlSelf->current_state))) {
            vlSelf->seconds = ((0x3bU == (IData)(vlSelf->seconds))
                                ? 0U : (0x3fU & ((IData)(1U) 
    ...
    __Vtableidx1 = (((IData)(vlSelf->stop) << 5U) | 
                    (((IData)(vlSelf->start) << 4U) 
                     | (((IData)(vlSelf->current_state) 
                         << 2U) | (((IData)(vlSelf->reset) 
                                    << 1U) | (IData)(vlSelf->rst_n)))));
    if (Vstopwatch_top__ConstPool__TABLE_hb24ec1a9_0
        [__Vtableidx1]) {
        vlSelf->current_state = Vstopwatch_top__ConstPool__TABLE_hc0c450b6_0
            [__Vtableidx1];
    }
    vlSelf->minutes = __Vdly__minutes;
    vlSelf->stopwatch_top__DOT__min_increment = ((0x3bU 
                                                  == (IData)(vlSelf->seconds)) 
                                                 & (1U 
                                                    == (IData)(vlSelf->current_state)));
}
