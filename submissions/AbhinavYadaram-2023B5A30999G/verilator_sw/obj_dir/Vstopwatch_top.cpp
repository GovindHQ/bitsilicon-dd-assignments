...
void Vstopwatch_top::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("../rtl/../rtl/stopwatch_top.v", 4, "",
...
VL_INLINE_OPT void Vstopwatch_top::_sequent__TOP__1(Vstopwatch_top__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->stopwatch_top__DOT__fsm_inst__DOT__current_state 
        = ((IData)(vlTOPp->rst_n) ? (IData)(vlTOPp->stopwatch_top__DOT__fsm_inst__DOT__next_state)
            : 0U);
    if (vlTOPp->rst_n) {
        if (vlTOPp->stopwatch_top__DOT__clear_counters) {
            __Vdly__minutes = 0U;
        } else {
            if (vlTOPp->stopwatch_top__DOT__seconds_overflow) {
    ...
    if (vlTOPp->rst_n) {
        if (vlTOPp->stopwatch_top__DOT__clear_counters) {
            __Vdly__seconds = 0U;
            vlTOPp->stopwatch_top__DOT__seconds_overflow = 0U;
        } else {
            if (vlTOPp->stopwatch_top__DOT__enable_counting) {
                vlTOPp->stopwatch_top__DOT__seconds_overflow = 0U;
                if ((0x3bU == (IData)(vlTOPp->seconds))) {
                    __Vdly__seconds = 0U;
                    vlTOPp->stopwatch_top__DOT__seconds_overflow = 1U;
                } else {
                    __Vdly__seconds = (0x3fU & ((IData)(1U) 
...
VL_INLINE_OPT void Vstopwatch_top::_settle__TOP__2(Vstopwatch_top__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->__Vtableidx1 = (((IData)(vlTOPp->reset) 
                             << 4U) | (((IData)(vlTOPp->stop) 
                                        << 3U) | (((IData)(vlTOPp->start) 
                                                   << 2U) 
                                                  | (IData)(vlTOPp->stopwatch_top__DOT__fsm_inst__DOT__current_state))));
    vlTOPp->stopwatch_top__DOT__fsm_inst__DOT__next_state 
        = vlTOPp->__Vtable1_stopwatch_top__DOT__fsm_inst__DOT__next_state
        [vlTOPp->__Vtableidx1];
    vlTOPp->stopwatch_top__DOT__enable_counting = vlTOPp->__Vtable1_stopwatch_top__DOT__enable_counting
        [vlTOPp->__Vtableidx1];
    vlTOPp->stopwatch_top__DOT__clear_counters = vlTOPp->__Vtable1_stopwatch_top__DOT__clear_counters
        [vlTOPp->__Vtableidx1];
    vlTOPp->status = vlTOPp->__Vtable1_status[vlTOPp->__Vtableidx1];
}
