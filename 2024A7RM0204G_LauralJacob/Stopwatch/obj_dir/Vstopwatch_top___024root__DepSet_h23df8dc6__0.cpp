...
VL_INLINE_OPT void Vstopwatch_top___024root___nba_sequent__TOP__0(Vstopwatch_top___024root* vlSelf) {
    ...
    if (vlSelf->rst_n) {
        if ((1U == (IData)(vlSelf->stopwatch_top__DOT__fsm__DOT__present_s))) {
            __Vdly__seconds = ((0x3bU == (IData)(vlSelf->seconds))
                                ? 0U : (0x3fU & ((IData)(1U) 
                                                 + (IData)(vlSelf->seconds))));
        } else if ((0U == (IData)(vlSelf->stopwatch_top__DOT__fsm__DOT__present_s))) {
            __Vdly__seconds = 0U;
        }
        if ((0U == (IData)(vlSelf->stopwatch_top__DOT__fsm__DOT__present_s))) {
            __Vdly__minutes = 0U;
        } else if (((1U == (IData)(vlSelf->stopwatch_top__DOT__fsm__DOT__present_s)) 
                    & (0x3bU == (IData)(vlSelf->seconds)))) {
            __Vdly__minutes = ((0x63U == (IData)(vlSelf->minutes))
                                ? 0U : (0xffU & ((IData)(1U) 
                                                 + (IData)(vlSelf->minutes))));
        }
        vlSelf->stopwatch_top__DOT__fsm__DOT__present_s 
            = vlSelf->stopwatch_top__DOT__fsm__DOT__next_s;
    } else {
        __Vdly__seconds = 0U;
        __Vdly__minutes = 0U;
        vlSelf->stopwatch_top__DOT__fsm__DOT__present_s = 0U;
    }
...
#endif
            VL_FATAL_MT("rtl/stopwatch_top.v", 1, "", "Input combinational region did not converge.");
        }
